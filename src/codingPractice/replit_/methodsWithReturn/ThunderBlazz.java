...
public class ThunderBlazz {
    ...
    public static boolean getThunderBlazz(boolean avilable,boolean gift, int ingredient1, int ingredient2, int ingredient3){

        if(avilable && gift || avilable || gift ){
            return true;
        }else if(!avilable && !gift & ingredient1 == 1 && ingredient2 == 2 && ingredient3==3){
            return true;
        }else if(!avilable && !gift && ingredient1==3 && ingredient2 ==1 && ingredient3==2){
            return  true;
        }else{
            return false;
        }
