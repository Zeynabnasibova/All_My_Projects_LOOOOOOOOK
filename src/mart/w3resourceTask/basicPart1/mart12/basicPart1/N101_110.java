package mart.w3resourceTask.basicPart1.mart12.basicPart1;

public class N101_110 {
    /*
    101. Write a Java program to check if the number of 10 is greater than number to 20 in a given array of integers. Go to the editor
Click me to see the solution

102. Write a Java program to check if a specified array of integers contains 10 or 30. Go to the editor
Click me to see the solution
