...
public class Fundamentals {
    	/*
		  Constructor Method:
		  	...
		  	3. constructor method can only be called in a other constructor method.
		  	...
		  	8. if parent class does not have default constructor method but other constructors, then the parent' class constructor has to be called in child class FIRST
		  	9. default constructor in parent class is already called in child class by default
