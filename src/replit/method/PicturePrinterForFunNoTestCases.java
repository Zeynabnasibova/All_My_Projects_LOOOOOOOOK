...
public class PicturePrinterForFunNoTestCases {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("which image they you to see?");
        String image = input.nextLine();



        if(image.equals("sunset")){
            printSunset();
        }else if(image.equals("earth")){
            printEarth();
        }else if(image.equals("desert")){
            printDesert();
        }
